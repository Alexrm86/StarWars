...
<details>
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-021-b-project-starwars-planets-search`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-021-b-project-starwars-planets-search/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-021-b-project-starwars-planets-search/pulls) e confira que o seu _Pull Request_ está criado
